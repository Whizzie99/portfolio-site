        ...
        <section className="home-content">
            <div className="left-section">
                <div className="container">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam delectus vitae doloremque odit repudiandae veritatis aspernatur! Corporis eos eveniet rerum.</p>
                    <div className="social-links">
                        <ul>
                            ...
                            <button>
                                <Link>Let's tour<i class="fas fa-arrow-right"></i></Link>
                            </button>
                        </ul>
                    </div>
                </div>
